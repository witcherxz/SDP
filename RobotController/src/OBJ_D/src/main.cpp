...
void start_DETECT(bool showCamera, ros::Publisher &pub){
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n;
    ros::Publisher pub = n.advertise<std_msgs::Bool>("objectFound", 10);

    while (ros::ok())
    {
        start_DETECT(true, pub);
    }
}
