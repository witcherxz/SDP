...
cv::Mat Localization::getPostion()
{
    ...
    // std::cout << "  disp_odom_x : " << disp_odom_x << std::endl;
    float filt_odom_x =  disp_odom_x + first_x;
    float filt_odom_y =  disp_odom_y + first_y; 
    // std::cout << " disp_odom_theta : " << disp_odom_theta  * (180/M_PI)<< " first_theta : " << first_theta  * (180/M_PI) << "\n";
    ...
    std::cout <<" fox" <<filt_odom_x <<"  disp_odom_x : " << disp_odom_x<< " first_x : " <<  first_x << "\n";
    std::cout <<" foy" <<filt_odom_y <<"  disp_odom_y : " << disp_odom_y<< " first_y : " <<  first_y << "\n";
    if(poseFromMarker.at<float>(0, 0) != 0 && poseFromMarker.at<float>(0, 1) != 0){
        ...
        firstTimeNewArucoDetected = false;
    }
